...
var tuftsState = {
	    ...
	    game.load.image('background', './states/bindr_designs/tufts_background.png');
	...
	create: function () {
		...
		var background = game.add.sprite(0 , 0, 'background');
		 background.height = game.height;
		 background.width = game.width;
		  green_bin = game.add.sprite(game.world.centerX -270, game.world.centerY + 100, 'g_bin');
		  blue_bin = game.add.sprite(game.world.centerX -100, game.world.centerY + 100, 'b_bin');
		  yellow_bin = game.add.sprite(game.world.centerX +70, game.world.centerY + 100, 'y_bin');
		 black_bin = game.add.sprite(game.world.centerX + 240 , game.world.centerY + 100, 'bl_bin');
