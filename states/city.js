...
var cityState = {
	    ...
	    game.load.image('background', './states/bindr_designs/city_background.png');
	...
	create: function () {
		...
		var background = game.add.sprite(0 , 0, 'background');
		 background.height = game.height;
		 background.width = game.width;
		  green_bin = game.add.sprite(game.world.centerX - 250, game.world.centerY + 100, 'g_bin');
		  blue_bin = game.add.sprite(game.world.centerX -80, game.world.centerY + 100, 'b_bin');
		  yellow_bin = game.add.sprite(game.world.centerX +90, game.world.centerY + 100, 'y_bin');
		 black_bin = game.add.sprite(game.world.centerX + 260 , game.world.centerY + 100, 'bl_bin');
		...
		answer = false;
		game.time.events.add(Phaser.Timer.MINUTE * .5, tempfunc, this);
	},
